...
import { Calendar, Trophy, MapPin, Clock, LogIn } from "lucide-react"; //Falta importar el User
        ...
        <div className="min-h-screen bg-gray-50" >
            ...
            < div className="max-w-7xl mx-auto px-4 py-8" >
                                ...
                                <div className="space-y-2" >
                                    {
                                        [
                                            ...
                                            <div
                                                key={i}
                                                className={`grid grid-cols-8 gap-2 p-3 rounded-lg text-sm ${i < 3
                ...
                <div className="mt-8" >
                    <Card>
                        <CardHeader>
                            <CardTitle className="text-[#0000db]" >
                                    ...
                                    [
                                        {
                                            ...
                                            description:
                                                "Se han implementado nuevas reglas que entrarán en vigor a partir del próximo campeonato.",
                                            date: "10 Sep 2024",
                                            category: "Reglamento",
                                        },
                                        {
                                            title:
                                                "Inauguración de nuevas instalaciones deportivas",
                                            description:
                                                "Se inauguraron dos nuevas canchas que estarán disponibles para todos los clubes afiliados.",
                                            date: "08 Sep 2024",
                                        ...
                                        },
                                        {
                                            ...
                                            description:
                                                "Conoce todas las fechas importantes del resto de la temporada incluyendo playoffs y finales.",
                                            date: "05 Sep 2024",
                                            category: "Calendario",
                                        },
                                    ].map((news, i) => (
                                        <div
                                            key={i}
                                            className="border-l-4 border-[#0000db] pl-4 py-2"
                                        >
