...
class ClubBase(BaseModel):
    ...
    nombre_club: str = Field(
        ..., max_length=120, min_length=4, description="Nombre del club."
    )
    fecha_fundacion: date = Field(..., description="Fecha de fundación del club.")
    fono_club: Optional[str] = Field(
        None, max_length=12, description="Teléfono del club."
    )
    direccion_club: str = Field(
        ..., max_length=500, min_length=10, description="Dirección del club."
    )
    ...
    color_primario: str = Field(
        ...
        min_length=7,
        max_length=7,
        description="Color principal del club en formato hexadecimal (ej: #ABC123).",
    )
    color_secundario: str = Field(
        ...,
        min_length=7,
        max_length=7,
        description="Color secundario del club en formato hexadecimal (ej: #ABC123).",
    )
    color_respaldo: Optional[str] = Field(
        None,
        description="Color respaldo del club en formato hexadecimal (ej: #ABC123).",
    )
...
class ClubRead(ClubBase):
    ...
    fecha_modificacion: datetime = Field(
        ..., description="Fecha de última modificación del club"
    )
...
class ClubUpdate(BaseModel):
    ...
    nombre_club: Optional[str] = Field(
        None, max_length=120, min_length=4, description="Nombre del club"
    )
    fecha_fundacion: Optional[date] = Field(
        None, description="Fecha de fundación del club"
    )
    fono_club: Optional[str] = Field(
        None, max_length=12, description="Teléfono del club"
    )
    direccion_club: Optional[str] = Field(
        None, max_length=500, min_length=10, description="Dirección del club"
    )
    email_club: Optional[str] = Field(
        None, max_length=320, description="Email del club"
    )
    logo_club: Optional[str] = Field(None, description="Ruta del archivo del logo.")
    color_primario: str = Field(
        ...,
