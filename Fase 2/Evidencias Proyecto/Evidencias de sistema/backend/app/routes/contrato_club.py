...
@router.get("/asociacion-{id_asociacion}/club-{id_club}", response_model=schemas.ContratoClubRead)
def get_contrato_club(
    id_asociacion: int,
    id_club: int,
...
@router.put("/asociacion-{id_asociacion}/club-{id_club}", response_model=schemas.ContratoClubRead)
